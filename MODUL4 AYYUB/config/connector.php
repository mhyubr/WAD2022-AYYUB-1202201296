...
$conn_user = mysqli_connect("localhost", "root", "", "wad_modul4_ayyub");
...
function registrasi($data) {
    ...
    $result = mysqli_query($conn_user, "SELECT email FROM user_ayyub WHERE email = '$email'");
    ...
    mysqli_query($conn_user, "INSERT INTO user_ayyub VALUES('', '$nama', '$email', '$sandi', '$nomor')");
