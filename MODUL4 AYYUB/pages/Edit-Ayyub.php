...
$id_detail = $_GET["id"];
$query = query("SELECT * FROM showroom_ayyub_table WHERE id_mobil = '$id_detail'");
if ($query) {
...
?>
    ...
    <head>
        ...
        <title>Show Room Ayyub | Edit</title>
    </head>
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <form action="ListCar-Ayyub.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="pemilik_mobil" class="form-label fw-bold" value="Ayyub - 1202201296">Nama Pemilik</label>
